-- MMS lead ownership certification-time hardening.
-- Apply only to the dedicated MMS commercial database after migration 0015.
...
values(
  ...
  'Lead ownership transfer now requires destination certification to have been issued by, and remain current at, the transfer timestamp.'
)
