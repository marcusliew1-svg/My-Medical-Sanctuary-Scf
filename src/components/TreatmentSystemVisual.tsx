...
const visualBySlug: Record<string, SystemVisual> = {
  ...
  "ecg-cardiovascular-risk-review": { title: "Heart & circulation", subtitle: "Electrical rhythm + risk", signal: "Rhythm · pressure · lipids", focus: ["ECG", "Blood pressure", "Cardiovascular risk"], accent: "from-[#eadfd8] via-white to-[#edf1ee]" },
  ...
  "gut-health-microbiome-support": { title: "Gut & microbiome", subtitle: "Digestive ecosystem", signal: "Symptoms first, test second", focus: ["Nutrition", "Bowel pattern", "Microbiome context"], accent: "from-[#e8eadf] via-white to-[#e8e0d7]" },
