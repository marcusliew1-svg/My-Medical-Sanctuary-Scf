  ...
  return (
    <div className="fixed bottom-4 right-4 z-40 hidden sm:block">
      <Link
        ...
        className="group flex items-center gap-3 rounded-full border border-white/40 bg-[#07151d]/92 p-2 pr-4 text-ivory shadow-[0_20px_60px_rgba(0,0,0,0.28)] backdrop-blur-xl transition duration-300 hover:-translate-y-1 hover:border-gold/45"
      >
        ...
        <span className="ml-1 text-gold-light transition group-hover:translate-x-0.5">→</span>
      </Link>
    </div>
  );
}
