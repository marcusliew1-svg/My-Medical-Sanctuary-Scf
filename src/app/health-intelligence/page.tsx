...
export default function HealthIntelligencePage() {
  return (
    <main>
      ...
      <PublicSectionShell><div className="grid gap-12 lg:grid-cols-[0.68fr_1.32fr]"><div><SectionHeading eyebrow="Four ways to understand more" title="Intelligence should clarify the next question." lead="The public experience helps people learn. Personalised interpretation, saved records and medicine decisions require authenticated access and qualified review." /><div className="mt-9"><ClinicalBoundary><strong>Price is not the same as access.</strong> A lower observed price does not establish lawful availability, clinical suitability, product equivalence or permission to import.</ClinicalBoundary></div></div><EditorialIndex items={intelligence} /></div></PublicSectionShell>
