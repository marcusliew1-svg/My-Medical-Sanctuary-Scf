      ...
      <section className="bg-ivory px-4 py-20 md:py-28">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-5 md:grid-cols-3">
            <Link href="/clinics" className="group overflow-hidden rounded-[1.75rem] bg-white shadow-soft"><div className="relative h-64"><Image src="/mms-health-screening-hero.png" alt="MMS clinic" fill className="object-cover transition duration-700 group-hover:scale-105" sizes="(min-width: 768px) 33vw, 100vw" /></div><div className="p-6"><p className="text-[10px] font-bold uppercase tracking-[.18em] text-deep-green">Clinic network</p><h3 className="mt-2 font-serif text-3xl text-navy">Visit MMS.</h3></div></Link>
            ...
            <Link href="/medical-tourism" className="group overflow-hidden rounded-[1.75rem] bg-white shadow-soft"><div className="relative h-64"><Image src="/mms-membership-journey.webp" alt="Malaysia and Thailand coordinated care" fill className="object-cover transition duration-700 group-hover:scale-105" sizes="(min-width: 768px) 33vw, 100vw" /></div><div className="p-6"><p className="text-[10px] font-bold uppercase tracking-[.18em] text-deep-green">Cross-border care</p><h3 className="mt-2 font-serif text-3xl text-navy">Malaysia ↔ Thailand.</h3></div></Link>
          </div>
        </div>
      </section>
